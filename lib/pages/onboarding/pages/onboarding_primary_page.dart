...
class OnboardingPrimaryPage extends StatelessWidget{
            ...
            child: Column(
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(context).textTheme.titleLarge?.copyWith(color: AppTheme.pearlWhite)
                ),
                const SizedBox(height: 12),
                Text(
                  'Alquila tu barco perfecto \n ahora mismo',
                  textAlign: TextAlign.center,
                  style: Theme.of(context).textTheme.titleLarge?.copyWith(color: AppTheme.pearlWhite.withValues(alpha: 0.6))
                ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      'Explorar Barcos', style: Theme.of(context).textTheme.headlineLarge?.copyWith(color: AppTheme.pearlWhite)
                    ),
                  ),
                ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      'Ya tengo una cuenta', style: Theme.of(context).textTheme.headlineLarge?.copyWith(color: AppTheme.deepNavy)
                    ),
                  ),
                ),
                ...
                TextButton(
                  ...
                  child: Text(
                    'Saltar Introducción',
                    style: Theme.of(context).textTheme.headlineSmall?.copyWith(color: AppTheme.pearlWhite)
                  ),
                ),
              ],
            ),
