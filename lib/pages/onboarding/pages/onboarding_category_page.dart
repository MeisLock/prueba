            ...
            child: Column(
              children: [
                ...
                Text(
                  ...
                  textAlign: TextAlign.center,
                  style: Theme.of(context).textTheme.titleSmall?.copyWith(color: AppTheme.pearlWhite.withValues(alpha: 0.6))
                ),
                CustomCard(
                  title: 'Velero', 
                ...
                Container(
                  ...
                  child: Text(
                    'Saltar', style: Theme.of(context).textTheme.headlineLarge?.copyWith(color: AppTheme.deepNavy)
                  ),
                ),
              ),
            ],
